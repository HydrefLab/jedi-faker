...
class Character extends Base
{
    ...
    protected static $characters = [
        ...
        'Salacious B. Crumb', 'Sebulba', 'Shada D\'ukal', 'Sheev Palpatine', 'Shmi Skywalker', 'Sidon Ithano',
        'Sonsigo', 'Slowen Lo', 'Sly Moore', 'Strono Tuggs', 'Sudswater Dillifay Glon', 'Sy Snootles',
