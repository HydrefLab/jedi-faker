...
class Character extends Base
{
    ...
    protected static $darkSide = [
        'Darth Maul',  'Darth Plagueis', 'Darth Sidious', 'Darth Vader', 'Dooku',
        'Grievous',
        'Kylo Ren',
        'Snoke',
    ];
    ...
    protected static $lightSide = [
        ...
        'Fi-Ek Sirch',
        'Galdos Stouff',
        'Jocasta Nu', 'Joclad Danva',
        'Khaat Qiyn', 'Ki-Adi-Mundi', 'Kit Fisto',
        'Obi-Wan Kenobi',
        ...
        'Plo Koon',
        'Rey',
        'Saesee Tiin', 'Sar Labooda', 'Sephjet Josall', 'Shaak Ti', 'Sifo-Dyas', 'Sora Bulq', 'Sta-Den Eekin',
        'Stass Allie',
        'Tarados Gon',
        'Que-Mars Redath-Gom', 'Qui-Gon Jinn', 'Quinlan Vos',
    ...
    protected static $characters = [
        ...
        'Boba Fett', 'Bobbajo', 'Bollie Prindel', 'Bossk', 'Breha Organa', 'Bren Derlin',
        'C\'ai Threnalli', 'C-3PO', 'Caluan Ematt', 'Camie Loneozner', 'Carlist Rieekan', 'Cassio Tagge', 'Chewbacca',
        'Chi Eekway Papanoida', 'Cliegg Lars', 'Conan Antonio Motti', 'Cratinus', 'Crix Madine', 'Crokind Shand', 'Crusher Roodown',
        'Dak Ralter', 'Datoo', 'Daultay Dofine', 'Deacon', 'Dengar', 'Dexter Jettster', 'Dineé Ellberger', 'DJ',
        'Dopheld Mitaka',
        'Edrison Peavey', 'Ello Asty',
        'Figrin D\'an', 'Finis Valorum', 'Finn', 'Firmus Piett',
        'Galak Fyyar', 'Garven Dreis', 'Gial Ackbar', 'Goss Toowers', 'Greedo', 'Gregar Typho', 'Grummgar',
        'Gwellis Bagnoro',
        'Han Solo', 'Hem Dazon',
        ...
        'Lando Calrissian', 'Lama Su', 'Lanever Villecham ', 'Larma D\'Acy', 'Laze Loneozner', 'Lirin Car\'n', 'Lobot',
        'Lor San Tekka', 'Lorth Needa',
        'Mas Amedda', 'Maximilian Veers', 'Maz Kanata', 'Moden Canady', 'Mon Mothma', 'Momaw Nadon', 'Munduri',
        'Nebit', 'Nien Nunb', 'Notluwiski Papanoida', 'Nute Gunray',
        'Oola', 'Owen Lars',
        'Padmé Amidala', 'Paige Tico', 'Passel Argente', 'Pello Scrambas', 'Phasma', 'Poe Dameron', 'Poggle the Lesser',
        'Prashee', 'Praster Ommlen', 'Pru Sweevant',
        ...
        'Tallissan Lintra', 'Tanbris', 'Tarfful', 'Taslin Brance', 'Taun We', 'Tasu Leech', 'Taybin Ralorsa', 'Tech Mo\'r',
        'Temiri Blagg', 'Temmin Wexley', 'Thanisson', 'Tiaan Jerjerrod', 'Tion Medon',
        'Ugloste',
        'Quarsh Panaka', 'Quiggold',
        'U.O. Statura', 'Ubert Quaril', 'Unamo', 'Unkar Plutt',
        'Vanden Willard', 'Vober Dand', 'Volzang Li-Thrull',
        'Watto', 'Wat Tambor',  'Wedge Antilles', 'Wes Janson', 'Wicket Warrick', 'Wilhuff Tarkin', 'Windy Starkiller', 'Wollivan',
        'Wuher',
        'Zam Wesell', 'Zuvio',
    ];
