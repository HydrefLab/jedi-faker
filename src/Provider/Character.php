...
class Character extends Base
{
    ...
    protected static $characters = [
        ...
        'Bail Prestor Organa', 'Bala-Tik', 'Bazine Netal', 'Beru Whitesun Lars', 'Biggs Darklighter', 'Boba Fett',
        'Bobbajo', 'Bollie Prindel', 'Bossk', 'Bren Derlin',
        'C\'ai Threnalli', 'C-3PO', 'Caluan Ematt', 'Camie Loneozner', 'Cassio Tagge', 'Chewbacca',
        'Conan Antonio Motti', 'Cratinus', 'Crix Madine', 'Crokind Shand', 'Crusher Roodown',
        'Datoo', 'Deacon', 'DJ', 'Dopheld Mitaka',
        ...
        'Lor San Tekka',
        'Mas Amedda', 'Maz Kanata', 'Moden Canady', 'Mon Mothma', 'Momaw Nadon', 'Munduri',
        ...
        'Sebulba', 'Shada D\'ukal', 'Sheev Palpatine', 'Shmi Skywalker', 'Sidon Ithano', 'Sonsigo', 'Slowen Lo',
        'Sly Moore', 'Strono Tuggs', 'Sudswater Dillifay Glon',
        'Tallissan Lintra', 'Tanbris', 'Taslin Brance', 'Taun We', 'Tasu Leech', 'Taybin Ralorsa', 'Tech Mo\'r',
        'Temiri Blagg', 'Temmin Wexley', 'Thanisson',
        'Quiggold',
        'U.O. Statura', 'Ubert Quaril', 'Unamo', 'Unkar Plutt',
        'Vanden Willard', 'Vober Dand', 'Volzang Li-Thrull',
        'Watto', 'Wedge Antilles', 'Wicket Warrick', 'Wilhuff Tarkin', 'Windy Starkiller', 'Wollivan', 'Wuher',
        'Zam Wesell', 'Zuvio',
    ];
