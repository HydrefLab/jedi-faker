...
class Species extends Base
{
    ...
    protected static $species = [
        'Aiwha', 'Aleena', 'Amani',
        'Balosar', 'Besalisk', 'Bith',
        'Cerean', 'Chandra-Fan', 'Chagrian',
        'Dactillion', 'Dathomirian', 'Devaronian', 'Dug', 'Duros',
        'Ewok',
        'Falumpaset',
        'Gamorreans', 'Geonosian', 'Givin', 'Gotal', 'Gran', 'Gungan',
        'Hutt',
        'Ithorians',
        'Jawa',
        'Kaadu', 'Kallidahin', 'Kaminoan', 'Klatooinian', 'Kubaz',
        'Luggabeast',
        ...
        'Rodian',
        'Saurin', 'Sullustan',
        'Talz', 'Togruta', 'Toydarian', 'Trandoshan', 'Twi\'lek',
        'Ugnaught', 'Utai',
        'Weequay', 'Wookiee',
    ];
